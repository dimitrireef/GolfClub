...
public class CircuitAdapter extends BaseAdapter {
	...
	private ArrayList<ListCircuit> data;
	...
	public CircuitAdapter(Activity a, ArrayList<ListCircuit> monCircuit) {
	...
	public void setCircuitListener(final int position){
		...
		holder.lyTrouverUnGolf.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				DetailDuCircuit.circuit_id=data.get(position).getId();
				Utils.animNextActivity(activity, DetailDuCircuit.class);
			}
		});
