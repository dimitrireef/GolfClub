...
import golf.club.app.message.FicheDuJoeurMessage;
...
public class MiseEnRelationAdapter extends BaseAdapter {
	...
	public MiseEnRelationAdapter(Activity a, ArrayList<Invitation> d) {
		...
		holder.lyTrouverUnGolf.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				try {
					...
					FicheDuJoeurMessage.Invitation_ID=data.get(position).getId();
					FicheDuJoeurMessage.date_prevu=formatted_date;
					FicheDuJoeurMessage.adversaire=nickName;

					Utils.animNextActivity(activity, FicheDuJoeurMessage.class);
